...
import cell.SickCell;
import cell.WhiteCell;
 ...
 * conquer the enemy cells and anti images.background.viruses
 * <p>
...
public class Virus extends Attacker implements Locatable {
    ...
    public void draw(Graphics g, int xOffset, int yOffset) {
        BufferedImage in;
        URL url = ClassLoader.getSystemClassLoader().getResource("images/viruses/Virus" + number + ".png");
        File f;
        try {
