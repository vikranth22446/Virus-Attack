...
public class World implements Runnable {
    ...
    /**
     * the anti virus manager that holds the anti images.background.viruses
     */
     ...
     */
        try {
            URL url = ClassLoader.getSystemClassLoader().getResource("images/background/background.png");
            File f;
            try {
