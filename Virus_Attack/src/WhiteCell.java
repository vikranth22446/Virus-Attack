...
public class WhiteCell extends Cell
{
     ...
     * @param xOffset
     *            The offset of of graphics on x-axis
     * @param yOffset
     *            The offset of of graphics on x-axis
     */
    @Override
     ...
     * 
     * @param attacked
     *            whether cell is being attacked
     */
     ...
     * 
     * @param g
     *            the Graphics component for the canvas
     * @param xOffset
     *            the x fix for the canvas
     * @param yOffset
     *            the y fix for the canvas
     */
